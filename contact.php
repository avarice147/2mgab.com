...
<head>
    ...
    <title> 2MGAB | Master Barber</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/favicon.ico">
    <meta property="og:title" content="2MGAB">
   <meta property="og:image" content="assets/img/gallery/gallery11.png">
   ...
   <!-- CSS here -->
    ...
    <link rel="stylesheet" href="assets/css/style.css?change=2">
</head>
    <!--? Preloader Start -->
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets/img/logo/logo-michael.png" alt="">
                </div>
            </div>
        </div>
    </div>
...
if(isset($_SESSION['contactcheck']) && isset($_GET['Success'])){
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.html"><img src="assets/img/logo/logo-michael.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col-xl-10 col-lg-10 col-md-10">
                            <div class="menu-main d-flex align-items-center justify-content-end">
                                ...
                                <div class="header-right-btn f-right d-none d-lg-block ml-30">
                                    <a href="contact.html" class="btn header-btn">book now</a>
                                </div>
                            </div>
                        </div>   
                        <!-- Mobile Menu -->
        ...
        <!-- <section class="contact-section">
            <div class="container">
                <div class="d-none d-sm-block mb-5 pb-4">
                    ...
                    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCKCeh9BBDOqZ9MKEdKn6PcPLdZi_B7wFg&amp;callback=initMap">
                    </script>
    
                </div> -->
<section class="api-section">
    <div>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3269.017392180349!2d-81.32790222345044!3d28.580401789147025!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88e76558e4504911%3A0xece8ca14310a29d3!2s2001%20Glenridge%20Way%2C%20Winter%20Park%2C%20FL%2032792!5e0!3m2!1sen!2sus!4v1702219058465!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</section>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <form class="form-contact contact_form" action="contact_process.php" method="post" onsubmit="return validateForm()" id="contactForm2" novalidate="novalidate">
                            
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <select id="serviceSelect" name="cuttype">
                                            <option value="30 - Cut + Edge / Line Up">Cut + Edge / Line Up - $30</option>
                                            <option value="40 - Cut + Styling Designs + Edge / Line Up">Cut + Styling Designs + Edge / Line Up - $40</option>
                                            <option value="65 - Cut + Color + Edge Up">Cut + Color + Edge Up - $65</option>
                                            <option value="65 - Cut + Edge / Line Up + Tint">Cut + Edge / Line Up + Tint - $65</option>
                                            <option value="50 - Full Shave">Full Shave - $50</option>
                                            <option value="40 - Beard Trim / Style">Beard Trim / Style - $40</option>
                                            <option value="20 - Edge / Line Up">Edge / Line Up - $20</option>
                                            <option value="20 - Edge / Line Up">Other / Not listed , Specify - $0</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mt-4">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Briefly describe in more detail the service and appointment hours you prefer'" placeholder=" Briefly describe in more detail the service and appointment hours you prefer"></textarea>
                                        <small class="error1">Please enter your message</small>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" placeholder="Enter your name">
                                        <small class="error2">Please enter your name</small>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder="Email">
                                        <small class="error3">Please enter your email</small>
                                    </div>
                                    
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="csubject" id="subject2" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Phone Number'" placeholder="Enter Phone Number">
                                        <small class="error4">Please enter your subject</small>
                                    </div>
                                </div>
                               
                            </div>
                            <div class="form-group mt-3">
                                <button type="submit" class="button button-contactForm boxed-btn"  id="">Send</button>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-3 offset-lg-1">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>+407 376 2033</h3>
                                <p>Mon to Sun 6am to 6pm</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>2mgabucan@gmail.com</h3>
                      ...
                      <div class="footer-logo">
                                ...
                                <div class="footer-tittle">
                                    <div class="footer-pera">
                                        <p class="info1">Feel free to Call or email for any inquiries or questions.</p>
                                    </div>
                                </div>
                                <div class="footer-number">
                                    <h4><span>+407 </span>376 2033</h4>
                                    <p>2mgabucan@gmail.com</p>
                                </div>
                            </div>
                        </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
   ...
   <script>
    function validateForm() {
        var serviceSelectValue = document.getElementById('serviceSelect').value.trim();
        ...
        var subjectValue = document.getElementById('subject2').value.trim();
